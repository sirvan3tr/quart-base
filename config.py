...
class Config:
    DEBUG = False
    APP_NAME = os.environ.get('APP_NAME', 'QuartApp')
    ...
    TOKEN_EXAMPLE = os.environ.get('TOKEN_EXAMPLE', None)
    ...
    ADMIN_EMAIL = os.environ.get('ADMIN_EMAIL', 'flask-vuejs-admin@example.com')
...
class DevelopmentConfig(Config):
    ...
    def init_app(cls, app):
        print('Running Dev Config. THIS APP IS IN DEBUG MODE. \
